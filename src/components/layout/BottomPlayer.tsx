...
import { Play, Pause, SkipForward, SkipBack, Shuffle, Repeat, Repeat1, Volume2, Volume1, VolumeX, Maximize2, ListMusic, Mic2 } from 'lucide-react';
...
export function BottomPlayer() {
  const {
    ...
    playPrevious,
    seek,
    setVolume, // This is handleSetVolume from context
    toggleMute,
    toggleShuffle,
    cycleRepeatMode,
